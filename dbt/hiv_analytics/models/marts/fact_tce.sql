...
meas as (
    ...
    select
        coalesce(r.xml_filename, c.xml_filename) as xml_filename,
        r.baseline_log_rna,
        r.followup_log_rna,
        c.baseline_cd4,
        c.followup_cd4
    from rna r
    full outer join cd4 c
        on r.xml_filename = c.xml_filename
